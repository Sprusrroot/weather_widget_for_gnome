...
**INSTRUCTION:**
  ...
  2. Install Hidamari
  3. Change City and API (api for openweathermap) in script.js file (also you can change wallpaper image in style.css file).
  4. Open Hidamari
  5. Select Web Page -> Local Web Page -> select index.html file
